...
```shell
gem install ./cloudmersive-ocr-api-client-1.3.6.gem
```
(for development, run `gem install --dev ./cloudmersive-ocr-api-client-1.3.6.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cloudmersive-ocr-api-client', '~> 1.3.6'
